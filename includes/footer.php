...
?>
        <footer class="footer">
            <div class="container-fluid d-flex justify-content-between">
                <nav class="pull-left">
                    <ul class="nav">
                        <li class="nav-item">
                            <a class="nav-link text-muted" href="<?= BASE_URL ?>admin/index.php">Admin Panel</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-muted" href="<?= BASE_URL ?>admin/reports.php">Vaccination Reports</a>
                        </li>
                    </ul>
                </nav>
                <div class="copyright text-muted">
                    &copy; <?= date('Y') ?> <strong>VaxCare</strong> &bull; Child Vaccination Management System
                </div>
            </div>
        </footer>
    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            // Synchronize theme and icon on document load
